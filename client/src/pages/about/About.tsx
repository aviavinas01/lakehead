...
import { Check, Pin, Arrow, Shot } from "../../components/shared/destinationBits";
...
import StatMarquee, { type StatItem } from "../../components/shared/StatMarquee";
  ...
  return (
    <article className="dpage dpage-ruled who" ref={root}>
      ...
      {/* ---- the team ----
          ...
          heading included. See components/about/StaffGrid.tsx. */}
      <StaffGrid />
