...
const FlagUS = () => (
  <svg viewBox="0 0 32 32" aria-hidden="true">
    <clipPath id="flag-us"><circle cx="16" cy="16" r="16" /></clipPath>
...
const FlagIndia = () => (
  <svg viewBox="0 0 32 32" aria-hidden="true">
    <clipPath id="flag-in"><circle cx="16" cy="16" r="16" /></clipPath>
    <g clipPath="url(#flag-in)">
      ...
      <circle cx="16" cy="16" r="3" fill="none" stroke="#054187" strokeWidth="1.4" />
    </g>
  </svg>
);
...
const FlagSweden = () => (
  <svg viewBox="0 0 32 32" aria-hidden="true">
    <clipPath id="flag-se"><circle cx="16" cy="16" r="16" /></clipPath>
...
const FlagSpain = () => (
  <svg viewBox="0 0 32 32" aria-hidden="true">
    <clipPath id="flag-es"><circle cx="16" cy="16" r="16" /></clipPath>
...
const FlagItaly = () => (
  <svg viewBox="0 0 32 32" aria-hidden="true">
    <clipPath id="flag-it"><circle cx="16" cy="16" r="16" /></clipPath>
...
const FlagBelgium = () => (
  <svg viewBox="0 0 32 32" aria-hidden="true">
    <clipPath id="flag-be"><circle cx="16" cy="16" r="16" /></clipPath>
...
const FlagUK = () => (
  <svg viewBox="0 0 32 32" aria-hidden="true">
    <clipPath id="flag-uk"><circle cx="16" cy="16" r="16" /></clipPath>
      ...
      <div className="hero-orbit">
        {entries.map((e) =>
          e.kind === "flag" ? (
            ...
            >
              <span className={`orbit-badge${e.small ? " orbit-badge-sm" : ""}`}>{e.node}</span>
            </span>
          ) : (
            <span
              key={e.angle}
